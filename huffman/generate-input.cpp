...
int main()
{
    ...
    const string outputPath = "continuous-tests/shortsine-10m.in";

    random_device rd;
    mt19937 gen(rd());
    normal_distribution<float> dis(14, noiseStdDev);
    ...
    for (int i = 0; i < n; ++i)
    {
        random = dis(gen) + sin(i * 2 * 3.14159265f / period) * amplitude + verticalShift;
